    ...
    <MAIN>
        ...
        <SECTION class="mvimg mv-026 mv-second" id="section-mv-culture">
            ...
            <div class="tit-m v-txt01">
                ...
                <p class="tit-s v-txt01">顧客に選ばれる企業として問題解決にもつながる、<br/>小さな「気づき」周囲への「配慮」を、<br/>大切にしています。</p>
            </div>
            ...
            <DIV class="container">
                ...
                <article class="flex-col2 box-culture" id="culture-1">
                    ...
                    <div class="order-md-1">
                        ...
                        <figure class="img-maru"><img src="img/pic/culture_10.jpg?<?= VER ?>" alt="企業文化写真3"></figure>
                    </div>
                </article>
                ...
                <article class="flex-col2 box-culture" id="culture-2">
                    ...
                    <div class="order-md-2">
                        <figure class="img-maru img-s"><img src="img/pic/culture_02.jpg?<?= VER ?>" alt="企業文化写真4"></figure>
                        <figure class="img-maru img-m"><img src="img/pic/culture_09.jpg?<?= VER ?>" alt="企業文化写真5"></figure>
                        <figure class="img-maru"><img src="img/pic/culture_14.jpg?<?= VER ?>" alt="企業文化写真6"></figure>
                    </div>
                </article>
                ...
                <article class="flex-col2 box-culture" id="culture-3">
                    ...
                    <div class="order-md-1">
                        <figure class="img-maru img-s"><img src="img/pic/culture_04.jpg?<?= VER ?>" alt="企業文化写真7"></figure>
